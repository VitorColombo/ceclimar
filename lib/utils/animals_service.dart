...
class AnimalService {
  ...
  List<Map<String, dynamic>> animalsCreate = [
    {
      'id': 1,
      'popularName': 'tartaruga-cabeçuda',
    ...
    {
      'id': 2,
      'popularName': 'lobo-marinho-sul-americano',
    ...
    {
      'id': 3,
      'popularName': 'pinguim-de-magalhães',
    ...
    {
      'id': 6,
      'popularName': 'leão-marinho-do-sul',
    ...
    {
      'id': 7,
      'popularName': 'tartaruga-de-couro',
    ...
    {
      'id': 10,
      'popularName': 'albatroz-de-nariz-amarelo',
    ...
    {
      'id': 12,
      'popularName': 'gambá-de-orelha-branca',
    ...
    {
      'id': 14,
      'popularName': 'baleia-franca-austral',
    ...
    },
    {
      'id': 17,
      'popularName': 'biguá',
      'scientificName': 'Nannopterum brasilianus',
      'genus': 'Nannopterum',
      'species': 'brasilianus',
    ...
    {
      'id': 18,
      'popularName': 'boto-de-lahille',
      'scientificName': 'Tursiops gephyreus',
      'genus': 'Tursiops',
      'species': 'gephyreus',
      'family': 'Delphinidae',
      'order': 'Cetacea',
    ...
    {
      'id': 19,
      'popularName': 'pernilongo-de-costas-brancas',
      'scientificName': 'Himantopus melanurus',
      'genus': 'Himantopus',
      'species': 'melanurus',
    ...
    {
      'id': 21,
      'popularName': 'bobo-grande-de-sobre-branco',
    ...
    {
      'id': 22,
      'popularName': 'cágado-de-barbelas',
    ...
    {
      'id': 24,
      'popularName': 'albatroz-de-sobrancelha',
    ...
    {
      'id': 26,
      'popularName': 'tartaruga-de-pente',
    ...
    {
      'id': 28,
      'popularName': 'golfinho-de-dentes-rugosos',
      'scientificName': 'Steno bradanensis',
      'genus': 'Steno',
      'species': 'bradanensis',
      'family': 'Delphinidae',
      'order': 'Cetacea',
    ...
    {
      'id': 29,
      'popularName': 'mandrião-parasítico',
    ...
    {
      'id': 30,
      'popularName': 'golfinho-comum-de-bico-curto',
    ...
    {
      'id': 33,
      'popularName': 'petrel-gigante-do-norte',
    ...
    {
      'id': 34,
      'popularName': 'elefante-marinho-do-sul',
    ...
    {
      'id': 36,
      'popularName': 'tubarão-martelo-entalhado',
    ...
    {
      'id': 37,
      'popularName': 'golfinho-nariz-de-garrafa',
    ...
    {
      'id': 38,
      'popularName': 'cágado-negro',
      'scientificName': 'Acanthochelys spixii',
      'genus': 'Acanthochelys',
      'species': 'spixii',
    ...
    {
      'id': 39,
      'popularName': 'asa-de-telha',
      'scientificName': 'Agelaioides badius',
      'genus': 'Agelaioides',
      'species': 'badius',
      'family': 'Fringillidae ',
      'order': 'Passeriformes',
    ...
    {
      'id': 40,
      'popularName': 'lobo-marinho-subantártico',
    ...
    {
      'id': 42,
      'popularName': 'baleia-minke-anã',
      'scientificName': 'Baleonoptera acutorostrata',
      'genus': 'Baleonoptera',
    ...
    {
      'id': 43,
      'popularName': 'baleia-minke-antártica',
    ...
    {
      'id': 44,
      'popularName': 'baleia-de-bryde',
      'scientificName': 'Baleonoptera brydei',
      'genus': 'Baleonoptera',
      'species': 'brydei',
      'family': 'Balaenopteridae',
      'order': 'Cetacea',
    ...
    {
      'id': 46,
      'popularName': 'maçarico-de-papo-vermelho',
    ...
    },
    {
      'id': 49,
      'popularName': 'baiacu',
      'scientificName': 'Chilomycterus spinosus',
      'genus': 'Chilomycterus',
      'species': 'spinosus',
    ...
    {
      'id': 56,
      'popularName': 'lontra-neotropical',
    ...
    {
      'id': 57,
      'popularName': 'medusa-mármore',
      'scientificName': 'Lychnorhiza lucerna',
      'genus': 'Lychnorhiza',
      'species': 'lucerna',
    ...
    {
      'id': 62,
      'popularName': 'caravela-portuguesa',
    ...
    {
      'id': 63,
      'popularName': 'mergulhão-grande',
      'scientificName': 'Podicephorus major',
      'genus': 'Podicephorus',
      'species': 'major',
    ...
    {
      'id': 67,
      'popularName': 'trinta-réis-de-bico-vermelho',
    ...
    {
      'id': 68,
      'popularName': 'polícia-inglesa-do-sul',
    ...
    {
      'id': 73,
      'popularName': 'moreia-pintada',
      'scientificName': 'Gymnothorax ocellatus',
      'genus': 'Gymnothorax',
      'species': 'ocellatus',
      'family': 'Muraenidae',
    ...
    {
      'id': 74,
      'popularName': 'treme-treme',
      'scientificName': 'Narcine brasiliensis',
      'genus': 'Narcine',
    ...
    },
    {
      'id': 75,
      'popularName': null,
      'scientificName': 'Arctocephalus sp.',
      'genus': 'Arctocephalus',
      'species': 'sp.',
      'family': 'Otariidae',
      'order': 'Carnivora',
    ...
    },
    {
      'id': 76,
      'popularName': null,
      'scientificName': 'Balaenoptera sp.',
      'genus': 'Balaenoptera',
      'species': 'sp.',
      'family': 'Balaenopteridae',
      'order': 'Cetacea',
    ...
    },
    {
      'id': 77,
      'popularName': null,
      'scientificName': 'Stercorarius sp.',
      'genus': 'Stercorarius',
      'species': 'sp.',
      'family': 'Stercorariidae',
      'order': 'Charadriiformes',
    ...
    },
    {
      'id': 79,
      'popularName': null,
      'scientificName': 'Thalassarche sp.',
      'genus': 'Thalassarche',
      'species': 'sp.',
      'family': 'Diomedeidae',
      'order': 'Procellariiformes',
    ...
    {
      'id': 89,
      'popularName': 'tuco-tuco-das-dunas',
    ...
    {
      'id': 91,
      'popularName': 'tucano-de-bico-verde',
    ...
    {
      'id': 93,
      'popularName': 'raia-viola',
      'scientificName': 'Rhinobatos horkelii',
      'genus': 'Rhinobatos',
      'species': 'horkelii',
      'family': 'Rhinobatidae',
      'order': 'Rajiformes',
    ...
    {
      'id': 98,
      'popularName': 'pica-pau-verde-barrado',
    ...
    {
      'id': 100,
      'popularName': 'baleia-piloto-de-barbatana-longa',
    ...
    },
    {
      'id': 102,
      'popularName': null,
      'scientificName': 'Lagocephalus sp',
      'genus': 'Lagocephalus',
      'species': 'sp ',
      'family': 'Tetraodontidae',
      'order': 'Tetraodontiformes',
    ...
    {
      'id': 103,
      'popularName': 'urubu-de-cabeça-vermelha',
    ...
    {
      'id': 106,
      'popularName': 'boto-de-Buermeister',
    ...
    {
      'id': 107,
      'popularName': 'peixe-cachimbo',
      'scientificName': 'Syngnathus folletti',
      'genus': 'Syngnathus',
      'species': 'folletti',
      'family': 'Syngnathidae',
    ...
    {
      'id': 109,
      'popularName': 'trinta-réis-boreal',
    ...
    {
      'id': 110,
      'popularName': 'jacaré-de-papo-amarelo',
    ...
    {
      'id': 111,
      'popularName': 'gaivota-rapineira',
      'scientificName': 'Stercorarius antarticus',
      'genus': 'Stercorarius',
      'species': 'antarticus',
      'family': 'Stercorariidae',
      'order': 'Charadriiformes',
    ...
    {
      'id': 112,
      'popularName': 'corredeira-listrada',
      'scientificName': 'Lygophis flavifrenatus',
      'genus': 'Lygophis',
    ...
    {
      'id': 113,
      'popularName': 'cagarra-de-cabo-verde',
    ...
    {
      'id': 115,
      'popularName': 'golfinho-pintado-do-Atlântico',
    ...
    {
      'id': 116,
      'popularName': 'foca-caranguejeira',
    ...
    {
      'id': 118,
      'popularName': 'tubarão-raposa',
      'scientificName': 'Alopias vulinus',
      'genus': 'Alopias',
      'species': 'vulinus',
      'family': 'Alopiidae',
      'order': 'Lamniformes',
    ...
    {
      'id': 121,
      'popularName': 'Sardinha',
      'scientificName': 'Sardinella brasiliensis',
      'genus': 'Sardinellla',
      'species': 'brasiliensis',
      'family': null,
      'order': null,
      'classe': 'Actiniopterygii',
      'quantity': 0,
      'imageUrl': '',
      'badgeUrl': ''
    },
    ...
    {
      'id': 124,
      'popularName': 'Raia Banjo',
      'scientificName': 'Zapteryx brevirostris',
      'genus': 'Zapteryx ',
